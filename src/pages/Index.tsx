        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              { icon: 'Sparkles', t: 'Кафе «Зодиак»', s: 'г. Шахунья, ул. Советская, д. 13', d: 'Праздничный банкет, живая музыка и танцы. Начало в 16:00.', maps: 'https://yandex.ru/maps/?text=Шахунья+ул.+Советская+13' },
            ].map((c, i) => (
